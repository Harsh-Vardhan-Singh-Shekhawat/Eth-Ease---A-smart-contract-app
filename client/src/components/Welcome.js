...
import {Loader} from './'
import { TransactionContext } from '../context/TransacitonsContext';
...
const handleSubmit = () => [
  ...
  const Input = ({placeholder ,name,type, value,handleChange}) => (
    ...
    className='my-2 w-full rounded-sm p-2 outline-none text-white border-none text-sm bg-transparent white-glassmorphism '
    />
  )
    ...
    <div className='flex flex-col w-full justify-center items-center'>
        <div className='flex mf:flex-row flex-col justify-between items-start md:p-20 py-12 px-4'>
            <div className='flex flex-1 justify-start flex-col mf:mr-10'>
               ...
               {!currentAccount && <button className='fkex flex-row justify-center items-center my-5 bg-[#2952e3] p-3 rounded-full hover:[#2546bd] cursor-pointer'
              ...
              <div className='p-3 justify-end items-start flex-col rounded-xl h-40 sm:w-72 w-full my-5 eth-card white-glassmorphism'>
                  <div className='flex justify-between flex-col w-full  h-full'>
                    ...
                    <div>
                      ...
                      </p><p className='text-white font-semibold text-lg mt-1'>
                          Ethereum
                      </p>
                    </div>
                  </div>
              </div>
              <div className='p-5 sm:w-96 w-full items-center flex flex-col blue-glassmorphism justify-start'>
